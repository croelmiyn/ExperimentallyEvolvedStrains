...
public class CellPropertiesR12D {
    ...
    static void updateRunState(CellR12D c, MersenneTwister rd){
    ...
    static boolean setPropertiesGUI(){
        ...
        gd.addNumericField("sigmaM", sigmam, 2, 6,"0 0.5");
        ...
        CellPropertiesR12D.setVelocity(v0,dv0);
        CellPropertiesR12D.setDiffcoeff(dr);
        CellPropertiesR12D.setRTprops(rtR,trR,dTheta);
        CellPropertiesR12D.setPathwayProps(n0,k0,m0,sigmak,sigmam);
    ...
    static void setPathwayProps(double n0,double k0,double m0,double sigmak,double sigmam){
        N0 =n0;
        K0 = k0;
        M0 = m0;
        sigmaK = sigmak;
